...
#macro SCRIBBLE_MSDF_BORDER_TRIM               2          //Edge trimming around the bounding box for MSDF glyphs (in pixels). This is useful for tidying up any glitches when scaling
